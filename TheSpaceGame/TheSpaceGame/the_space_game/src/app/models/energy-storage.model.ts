...
export class EnergyStorage extends PlaceableBuilding {
    ...
    constructor(
        ...
        super(EnergyStorage.BUILD_COSTS, EnergyStorage.DAMAGE_POINTS, 1, position, EnergyStorage.DAMAGE_POINTS,
            EnergyStorage.VECTOR_WIDTH, EnergyStorage.VECTOR_HEIGHT, EnergyStorage.UPGRADE_COSTS);
    }
    ...
    override draw(ctx: CanvasRenderingContext2D): void {
        ...
        if (energyStorageImage.complete) {
            ...
            ctx.fillText("Energy Station", this.position.x, this.position.y - 5);

...
export abstract class AbstractGameEntityFactory {
  ...
  public abstract CreateLongRangeMissileStation(position: Vector2D): PlaceableBuilding;
  public abstract CreateRepairStation(position: Vector2D): PlaceableBuilding;
  public abstract CreateEnergyGridConnector(position: Vector2D,startposition: Vector2D,endposition: Vector2D): IntermediateBuilding;
